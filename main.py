...
def attack(char_name: str, char_class: str) -> str:
    """Функция выводит сообщение о нанесенному урону."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция выводит сообщение об уроне."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция выводит сообщения о специальных умениях."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция выводит сообщения о тренировках."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция выводит информацию о персонажах."""
    approve_choice: str = ''
    char_class: str = ''
